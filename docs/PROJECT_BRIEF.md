        ...
        tinycache exists to solve a narrow, inspectable developer-tooling problem:
        Thread-safe LRU + TTL cache decorator for Python. Zero dependencies.
        ...
        Topics: cache, decorator, lru-cache, python, thread-safe, ttl-cache, zero-dependencies
